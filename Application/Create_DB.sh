    ...
    case $db_Name in
        ...
        *)
            ...
            echo -e "\n\e[31m ------The Name Must Be At Least 3 Characters -------\n \e[0m"
                ...
                echo -e "\n\e[31m ------Name must start with a letter, followed by letters, numbers, underscores, And Not Have Special Characters-------\n \e[0m"
            elif [ -d "$db_Name" ]; then
                echo -e "\n\e[31m ------Database Already Exists -------\n \e[0m"
            else
                # Ask for confirmation
                echo -e "\n\e[34m Are you sure you want to create a database with the name: \e[93m$db_Name\e[0m? [Y/N]"
                read -r confirmation
                case $confirmation in
                    [Yy])
                        ...
                        ;;
                    [Nn])
                        echo -e "\n\e[31m Database creation canceled \e[0m"
                        break
                        ;;
                    *)
                        echo -e "\n\e[31m Invalid choice. Database creation canceled \e[0m"
                        break
                        ;;
                esac
            fi
